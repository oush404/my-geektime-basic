...
import (
	...
	"my-geektime-basic/webook/internal/web/middleware"
	"my-geektime-basic/webook/pkg/ginx/middleware/ratelimit"
	"my-geektime-basic/webook/pkg/limiter"
...
func InitWebServer(mdls []gin.HandlerFunc,
	userHdl *web.UserHandler, artHdl *web.ArticleHandler, wechatHdl *web.OAuth2WechatHandler) *gin.Engine {
	server := gin.Default()
	server.Use(mdls...)
	userHdl.RegisterRoutes(server)
